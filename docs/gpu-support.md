...
[M3 退出审计](m3-exit-audit.md)已记录本次 160 节点复验与剩余阻塞项。
...
151 节点/295 案例；M3-05 增加 9 项，当前为 **160 个 pytest 节点、304 个语义案例**。
CPU 全量基线为 926 passed，零 skipped。M3-02/03/04/05 已在本地固定环境通过；
