...
- 当前测试基线：628 passed、零 skipped（dev 环境已包含 `ml_dtypes`）。
...
M0/M1、**M2-01 至 M2-06 已完成**。下一步 **M2-07**：Mask/Const/常量接口独立设计，
先评审布尔 tile mask、Const bool、宿主整数白名单与显式舍入常量的边界，形成 ADR 后实现。
