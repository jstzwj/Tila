...
EXPECTED_TESTS = 112  # M3-02 adds 8 actual-device launch/cache guard nodes
...
def main():
    ...
    try:
        ...
        argv = [sys.executable, "-m", "pytest", "tests/gpu_semantics.py", "tests/gpu_examples.py", "tests/gpu_launch.py", "-v", "-s",
